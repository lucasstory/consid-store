                ...
                <div className='flex flex-col'>
                    {aboutProps.page.content.value.document.children.map((element, key) => {
                        if (element.type === 'paragraph') {
                            ...
                            if (element.level === 2) {
                                return <h2 key={key} className='text-3xl font-bold text-orange-400 my-2'>{element.children[0].value}</h2>
                            } else if (element.level === 3) {
                                return <h3 key={key} className='text-2xl font-semibold text-gray-950 my-1'>{element.children[0].value}</h3>
                            } 
                        }
